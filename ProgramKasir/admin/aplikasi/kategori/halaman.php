...
if (isset($_POST['go'])) {
  $cari = $_POST['cari'];
  $data_kat = mysqli_query($koneksi, "SELECT * FROM kategori WHERE kategori LIKE '%" . $cari . "%'");
} else {
  $data_kat = mysqli_query($koneksi, "SELECT * FROM kategori LIMIT $halaman_awal, $batas");
}
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <b>
                <p class="modal-title" id="edit-kategori<?= $pro['id'] ?>" style="text-align: center; font-size: 18px;">Edit Data Kategori</p>
              </b>
