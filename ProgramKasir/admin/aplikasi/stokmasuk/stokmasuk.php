      ...
      <div class="row">
        <div class="col-sm-12 mb-3">
          <div class="well">
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="kdproduk" readonly="" name="kdproduk" aria-describedby="emailHelp"><span class="input-group-btn"><br>
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_produk"><b>Cari Kode Produk</b></button>
                </span>
          ...
          <div class="modal-footer">
            <a href="index.php?m=stokmasuk&s=title"><button type="button" class="btn btn-secondary">Close</button></a>
      ...
      <div class="modal-content">
        <form role="form" id="form-tambah" method="post" action="input.php">
          <div class="modal-header">
            <center>
              <h3 class="modal-title">Pilih Data Produk</h3>
            </center>
          </div>
          <div class="modal-body">
            ...
            <table width="100%" class="table table-hover" id="example">
              ...
              <tbody>
                <?php
                $no = 1;
                $data = mysqli_query($koneksi, " SELECT  * from tb_produk order by id ASC");
                foreach ($data as $sa) :
                ?>
                  <tr id="tb_produk" data-kdproduk="<?= $sa['kdproduk']; ?>" data-nm_produk="<?= $sa['nm_produk']; ?>" data-kategori="<?= $sa['kategori']; ?>" data-satuan="<?= $sa['satuan']; ?>" data-rak="<?= $sa['rak']; ?>" data-supplier="<?= $sa['supplier']; ?>" data-stok="<?= $sa['stok']; ?>">
                    <td>
                      <?php echo $no++; ?>
                    </td>
                    <td>
