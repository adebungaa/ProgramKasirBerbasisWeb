                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <b>
                              <p class="modal-title" id="edit-profil<?= $adm['id'] ?>" style="text-align: center; font-size: 18px;">Edit Data Admin</p>
                            </b>
                          ...
                          <div class="modal-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <select type="text" class="form-control" value="<?= $key['level']; ?>" id="exampleInputEmail1" name="level" aria-describedby="emailHelp" placeholder="Masukkan Level" required="">
                                  <option>admin</option>
                                  <option>kasir</option>
                                </select>
                              </div>
