        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <b>
                <p class="modal-title" id="edit-rak<?= $pro['id'] ?>" style="text-align: center; font-size: 18px;">Edit Data Rak</p>
              </b>
            ...
            <div class="modal-body">
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?= $pro['kdrak']; ?>" id="exampleInputEmail1" name="kdrak" aria-describedby="emailHelp" placeholder="Masukkan Kode" required="">
                  <small class="form-text text-muted">Masukkan Kode Rak</small>
                </div>
                <div class="form-group">
                  <label>Nama Rak</label>
                  <input type="text" name="namarak" value="<?= $pro['namarak']; ?>" class="form-control" required="">
                </div>
        ...
        <div class="modal fade" id="hapus-rak<?= $pro['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <b>
                  <p class="modal-title" id="hapus-rak<?= $pro['id'] ?>" style="text-align: center; font-size: 18px;">Apakah Anda Yakin Ingin Menghapus ?</p>
                </b>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
